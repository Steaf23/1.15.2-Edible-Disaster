...
public class WinterChunkGenerator extends NoiseChunkGenerator<WinterGenSettings> 
{
	...
	public WinterChunkGenerator(IWorld worldIn, BiomeProvider provider, WinterGenSettings settingsIn) {
