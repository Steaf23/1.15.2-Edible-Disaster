...
public class WinterPortalBlock extends Block 
{
	...
	public void onEntityCollision(BlockState state, World worldIn, BlockPos pos, Entity entityIn) 
	{
		...
		{
			entityIn.changeDimension(entityIn.dimension.getModType() == EDDimensions.WINTER_DIM.get() ? DimensionType.OVERWORLD : DimensionType.byName(WinterComp.WINTER_DIM_TYPE), 
					new ITeleporter() 
			{
                @Override
